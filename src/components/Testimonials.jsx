...
const Testimonials = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-[#1c242f] to-black relative">
      <div className="absolute inset-0 bg-gradient-to-b from-[#1c242f] to-black opacity-50"></div>
              ...
              <div className="swiper-wrapper flex gap-3">
                <div className="swiper-slide group bg-white border border-solid border-gray-300 rounded-2xl max-sm:max-w-sm max-sm:mx-auto p-6 transition-all duration-500 hover:border-indigo-600">
                  <div className="flex items-center gap-5 mb-5 sm:mb-9">
                    <img className="rounded-full" src="https://pagedone.io/asset/uploads/1696229969.png" alt="avatar" />
                  ...
                  <div className="flex items-center mb-5 sm:mb-9 gap-2 text-amber-500 transition-all duration-500">
                    ...
                    {/* Repeat the above svg elements as needed */}
                  </div>
